...
- 띄어쓰기:  p{ text-indent } 변경. 기본값(1.2)
- 페이지 마진: body{margin-* } 변경
- 장(챕터) 글꼴: h1
- 절(섹션) 글꼴: h2
...
- 주석 기능에 문제가 있다는 것을 알고는 있는데 디버깅 시간이 안난다.

- PDF 출력기능을 안쓴지 어언 몇해.. 동작하려나... 그때 무슨 생각으로 넣었는지 아직도 모르겠다.
