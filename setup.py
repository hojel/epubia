...
setup(
    ...
    data_files=[("target", ["target/None.css",
                ...
                ("template", ["template/separator.png"]),
                ("template/epub2", ["template/epub2/content.opf",
                              "template/epub2/toc.ncx",
                              "template/epub2/coverpage.xhtml",
                              "template/epub2/titlepage.xhtml",
                              "template/epub2/chapter.xhtml",
                              "template/epub2/generic.css",
                             ]),
                ("template/pdf", [
                              "template/pdf/xhtml2pdf.css",
                              "template/pdf/coverpage.html",
                             ]),
